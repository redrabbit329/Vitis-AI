...
[redrabbit comment]
	UG1221 - zcu102 base trd
	- The plugins launch the PL-based kernel generated by the Vitis software platform.
	- The PL-based kernel useds the Xilinx xfopenCV libraries. These libraries provide hardware-optimized implementations of a subset of the OpenCV libraries. They are implemented in C-code that is then synthesized to FPGA hardware using high level synthesis (HLS). 
